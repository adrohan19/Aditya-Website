        ...
        {this.props.desktop ?
          (<div className="nav-desktop">
            ...
            <div className="nav-right">
              ...
              <a href="/AdityaDhirResume.pdf" target="_blank" rel="noopener noreferrer" className="resume-button">Resume</a>
            </div>
          </div>)
          :
          (<div className="nav-mobile">
            ...
            {this.state.showMenu ? (<div className="menu-mobile-box">
              ...
              <div className="menu-bg-mobile">
                ...
                <div className='menu-mobile-button-box'>
                  <a href="/AdityaDhirResume.pdf" target="_blank" rel="noopener noreferrer" className="resume-mobile-button" onClick={this.toggleMenu}>Resume</a>
                </div>
              </div>
            </div>)
              :
